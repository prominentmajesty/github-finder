...
function User() {
  ...
  return <div className="w-full max-auto lg:w-10/12">
    <div className="mb-4">
        ...
        <div className="col-span-2">
            <div className="mb-6">
                ...
                <div className="mt-4 card-actions">
                    <a href={html_url} target='_blank' rel='noreferrer' className='btn btn-outline'></a>
                </div>
            </div>
            <div className="w-full rounded-lg shadow-md bg-base-100 stats">
                ...
                {blog && (
                    <div className="stat">
                        ...
                        <div className="text-lg stat-value">
                            <a href={`https://${blog}`} target='_blank' res='noreferrer'>{blog}</a>
                        </div>
                    </div>
                )}
                {twiter_username && (
                    <div className="stat">
                        ...
                        <div className="text-lg stat-value">
                            <a href={`https://twitter.com/${twiter_username}`} target='_blank' res='noreferrer'>{twiter_username}</a>
                        </div>
                    </div>
                )}
            </div>
